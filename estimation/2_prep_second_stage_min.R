##==================================================
##
## Script name: Prep Bid and Quantity Data for Type Estimation MIN in Julia 
##
...
load("data/estimation_step1_output_minfit.rdata")
...
### save main posterior mean estimates
