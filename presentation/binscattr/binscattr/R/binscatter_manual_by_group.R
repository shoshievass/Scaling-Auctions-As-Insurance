...
binscatter_manual_by_group <- function(data, y, x, bins=20, discrete=FALSE, scatter=FALSE, connectdots = FALSE,
  ...
  binned_data <- data %>%
    ...
    do(
      get_manual_binning_residuals(., !!y_label, !!x_label, controls, absorb, clustervars, bins)
    )
